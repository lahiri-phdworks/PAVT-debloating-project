...
RUN apt-get install -y libffi-dev build-essential virtualenvwrapper default-jre default-jdk
RUN pip install capstone angr ropgadget
RUN git clone https://github.com/michaelbrownuc/gality.git
RUN cd ./gality
