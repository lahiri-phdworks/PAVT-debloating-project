...
define internal void @process_aflag(i32 %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @process_bflag(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = mul nsw i32 80, %3
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @process_cflag(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = shl i32 %3, 20
...
35:                                               ; preds = %59, %tail
  ...
  %38 = call i32 (i32, i8**, i8*, ...) bitcast (i32 (...)* @getopt to i32 (i32, i8**, i8*, ...)*)(i32 %36, i8** %37, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #4
...
42:                                               ; preds = %40
  ...
  %44 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %43, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i64 0, i64 0)) #4
  %45 = load i32, i32* %5, align 4
  call void @process_aflag(i32 %45) #4
  br label %59

46:                                               ; preds = %40
  store i32 20, i32* %6, align 4
  %47 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %48 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0)) #4
  %49 = load i32, i32* %6, align 4
  call void @process_bflag(i32 %49) #4
  br label %59

50:                                               ; preds = %40
  store i32 30, i32* %7, align 4
  %51 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %52 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %51, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i64 0, i64 0)) #4
  %53 = load i32, i32* %7, align 4
  call void @process_cflag(i32 %53) #4
  br label %59
...
54:                                               ; preds = %40
  ...
  %58 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %55, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i64 0, i64 0), i8* %57) #4
